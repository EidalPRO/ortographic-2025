...
<body class="index-page">
    ...
    <footer id="footer" class="footer dark-background">
        <div class="container">
            <h3 class="sitename">Ortographic Web</h3>
            <!-- <ul> -->
            <p class="m-2">Proyecto presentado como prototipo de software para la DEGETI.</p>
            <p class="m-2"> CBTis No 150.</p>
            <p class="m-2">Ocotlán de Morelos, Oaxaca, México.</p>
            <!-- </ul> -->
