    ...
    <div class="container text-center" data-aos="fade-up" data-aos-delay="100">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <p style="color: white;">Estamos trabajando en ello. Pronto se actualizara la pagina!</p>
            </div>
            <div class="countdown d-flex justify-content-center" data-count="2025/12/3" style="color: white;">
                <div>
                    <h3 class="count-days" style="color: white;">482</h3>
                    <h4 style="color: white;">Días</h4>
                </div>
                <div>
                    <h3 class="count-hours" style="color: white;">6</h3>
                    <h4 style="color: white;">Horas</h4>
                </div>
                <div>
                    <h3 class="count-minutes" style="color: white;">49</h3>
                    <h4 style="color: white;">Minutos</h4>
                </div>
                <div>
                    <h3 class="count-seconds" style="color: white;">41</h3>
                    <h4 style="color: white;">Segundos</h4>
                </div>
            </div>
